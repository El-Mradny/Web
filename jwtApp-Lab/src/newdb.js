...
class Carts extends DB {
    ...
    async findByPatientid(patientid){
        return this.reformatAll(await this.find(`search/findByPatientid?patientid=${patientid}`))
    }

    async findByPatientidAndStatus(patientid,status){
        return this.reformatAll(await this.find(`search/findByPatientidAndStatus?patientid=${patientid}&status=${status}`))
    }
...
class Cartitems extends DB {
    ...
    async findByCartid(cartid) {
        return this.reformatAll(await this.find(`search/findByCartid?cartid=${cartid}`))
    }
